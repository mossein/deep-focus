...
function updateStatCards(dailyStats, analytics) {
  ...
  document.getElementById('averageFocusScore').textContent = 
...
function updateCharts(analytics) {
  createLineChart('focusTimeChart', 'Daily Focus Time', 
    analytics.dates, analytics.focusHistory, 'Hours', '#2196F3');
  
  createLineChart('focusScoreChart', 'Focus Score Trend', 
    analytics.dates, analytics.scoreHistory, 'Score', '#4CAF50');
  
  createBarChart('distractionsChart', 'Daily Distractions', 
    analytics.dates, analytics.distractionHistory, '#FF9800');
  
  createBarChart('websiteBlocksChart', 'Blocked Site Attempts', 
    analytics.dates, analytics.blockedSitesHistory, '#F44336');
}
